...
def main():
    st.set_page_config(
        page_title="AI Resume Job Title Predictor",
        page_icon="🤖",
        layout="wide"
    )
    
    st.title("🤖 AI-Powered Resume Job Title Predictor")
    st.markdown("Upload your resume and get intelligent job title predictions using Hugging Face AI models!")
